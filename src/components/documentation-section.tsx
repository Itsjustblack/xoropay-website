	...
	const cards = [
		{
			...
			description:
				"Integrate in minutes with just a few lines of code. Power everything from one-time payments to complex subscriptions.",
			image: "/modern-dashboard-interface-with-data-visualization.jpg",
		},
		{
			title: "Webhook debugging made easy",
			description:
				"Built-in retry logic, detailed logs, and a powerful debugging interface help you handle every scenario",
			image: "/analytics-dashboard.png",
		},
		{
			title: "Detailed Documentation",
			description:
				"Interactive API docs with code examples and step-by-step integration guides",
